...
public class KalanblowLoginSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
     ...
     * @param authentication L'objet représentant l'authentification réussie.
     * @throws ServletException En cas d'erreur lors de la gestion de la servlet.
     * @throws IOException      En cas d'erreur d'entrée/sortie lors de la gestion de la redirection.
     */
    @Override
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws ServletException, IOException {
        ...
        if (isStudent(kalanblowUserDetails)){
    ...
    private boolean isStudent(KalanblowUserDetails userDetails) {
        return userDetails.getAuthorities().stream()
                .anyMatch(authority -> authority.getAuthority().equalsIgnoreCase(UserRole.STUDENT.getValue()));
    }
