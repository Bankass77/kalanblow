...
public class EtablissementServiceImpl implements EtablissementService {
    ...
    @Autowired
    public EtablissementServiceImpl(EtablissementRepository etablissementScolaireRepository) {
     ...
     */
    @Override
    public Etablissement creerEtablissementScolaire(CreateEtablissementParameters createEtablissementScolaireParameters) {
     ...
     */
    @Override
    public Etablissement miseAJourEtablissementScolaire(long id, EditEtablissementParameters editEtablissementScolaireParameters) {
